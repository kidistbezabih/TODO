        ...
        <div class="h-[70vh]  w-[30vw] bg-white flex-column rounded-lg p-4 relative">
            ...
            <ul class="my-4 p-4 h-[85%] overflow-y-auto">
              <div class="mt-3 mb-9 h-[5%] text-sm text-[#8ea6c8] flex justify-between items-center">
                  <a href="./completed.php" class="px-4 py-3 bg-blue-500 text-white rounded-[7px]"><strike>Completed Tasks</strike></a>
                  <a href="./create.php" class="px-4 py-3 bg-green-500 text-white rounded-[7px]">Create New Task</a>
              </div>
